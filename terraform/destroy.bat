...
terraform init 
terraform destroy -lock=false --var-file=./tfvars_files/dev.tfvars --var client_id="88376f43-c3ee-4be1-bd05-20c20128b666" --var client_secret="did8Q~cYC_by1Hk7bxeI9gph7ztwJGTcVsAlGbxc" --var tenant_id="607d63ca-9f36-4ad8-9f71-8b3efc392eb1" --var subscription_id="fa77afbb-f924-48ff-9fa3-5cd94bf4cb57"