...
gcloud container clusters get-credentials gke-microservices1691715-prod --region=europe-central2-a --project=i-binder-461513-v8

kubectl config set-credentials gke_i-binder-461513-v8_europe-central2_gke-microservices1691715-prod \
...
terraform apply --var-file=./tfvars_files/prod.tfvars \
